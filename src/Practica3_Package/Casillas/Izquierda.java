 ...
 * @author jordi
 */
public class Izquierda extends Casilla {

    public Izquierda(Mapa mapa) {
        super(mapa);
    }

    @Override
    public double calcularDistancia(Coordenadas a, Coordenadas b, int[][] mapaVeces) {
        Coordenadas a2 = new Coordenadas(a.getFila(), a.getColumna() - 1);
    ...
    public boolean see(Coordenadas a) {
        Coordenadas c = new Coordenadas(a.getFila(), a.getColumna() - 1);
        return this.sensor.comprobar(c);
    }

    @Override
    public Coordenadas getPosicion(Coordenadas a) {
        return new Coordenadas(a.getFila(), a.getColumna() - 1);
    }
}
